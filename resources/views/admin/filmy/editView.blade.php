    ...
    <div class="max-w-3xl mx-auto py-10 px-4">
        ...
        <form action="{{ route('admin.filmy.update', $film->id) }}" method="POST">
            ...
            <div class="mb-4">
                ...
                <input type="text" name="tytul" value="{{ old('tytul', $film->tytul) }}" class="w-full p-2 rounded bg-white/10 text-white" required>
            </div>
            ...
            <div class="mb-4">
                ...
                <input type="number" name="czas_trwania" value="{{ old('czas_trwania', $film->czas_trwania) }}" class="w-full p-2 rounded bg-white/10 text-white" required>
            </div>

            <div class="mb-4">
                <label class="text-white block mb-1">Nazwa pliku plakatu (poster)</label>
                <input type="text" name="poster" value="{{ old('poster', $film->poster) }}" class="w-full p-2 rounded bg-white/10 text-white" required>
            </div>
