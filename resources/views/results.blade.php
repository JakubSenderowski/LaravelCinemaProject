<x-default>
    ...
    @if($filmy->isEmpty())
        <p class="text-red-400 text-center mt-8">Brak filmów spełniających kryteria wyszukiwania.</p>
    @else
        <div class="grid grid-cols-1 md:grid-cols-4 gap-8 px-4">
            @foreach($filmy as $film)
                <div class="bg-gray-800 rounded-xl shadow-lg overflow-hidden flex flex-col items-center p-4">
                    <x-movie-poster
